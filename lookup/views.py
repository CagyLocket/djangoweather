...
def home(request):
	import json
	import requests #it does not go with django, in the terminall: pip3 install requests

	if request.method == "POST":
		zipcode = request.POST['zipcode']

		api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=25&API_KEY=EBBCF301-D5E9-4CF3-83A6-29802FD515D5")
		...
		if api[0]['Category']['Name'] == "Good":
			category_description = "(0-50) Air quality is considered satisfacotry, and air pollution poses little or no risk."
			category_color = "good"
		...
		#return render(request, 'lookup/home.html', {'zipcode': zipcode })

	else:
		api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=20002&distance=25&API_KEY=EBBCF301-D5E9-4CF3-83A6-29802FD515D5")
